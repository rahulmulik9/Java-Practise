...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        public class Main {
            public static void main(String[] args) {
                Thread installThread = new Thread(new InstallTask(), "InstallThread");
                installThread.start();
            }
        }
*/
        ...
        try {
            thread.join();  // This line makes the main thread wait until installThread finishes.
        } catch (
